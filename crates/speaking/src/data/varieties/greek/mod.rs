...
pub fn variety(id: &str) -> LinguisticVariety {
    ...
    LinguisticVariety {
        ...
        punctuation: Some(crate::data::varieties::greek_punctuation_profile()),
        question_contours: Some(crate::data::varieties::greek_question_contour_profile()),
        ...
        orthography: Some(Orthography {
            ...
            sample_words: vec!["και".into()],
            sample_letter_units: vec!["Α".into(), "Β".into()],
            ..Default::default()
        }),
        morphology: None,
