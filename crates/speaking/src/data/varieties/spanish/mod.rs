...
pub fn variety(id: &str) -> LinguisticVariety {
    ...
    LinguisticVariety {
        ...
        punctuation: Some(crate::data::varieties::spanish_punctuation_profile()),
        question_contours: Some(crate::data::varieties::spanish_question_contour_profile()),
...
pub fn syntax_profile() -> HeuristicSyntaxProfile {
    HeuristicSyntaxProfile {
        ...
        particles: &[],
        enclitic_suffixes: &[],
        complementizers: &["que", "quien", "quién", "si", "cuando", "como", "porque"],
        ...
        verbs: &[
            ...
            "venir", "viene", "vienen", "ver", "ve", "dar", "decir", "digo", "dice", "leer", "lee",
            "leen", "pensar", "piensa", "piensan", "hablar", "comer", "vivir",
        ],
        verb_suffixes: &[
