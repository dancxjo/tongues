...
pub fn syntax_profile() -> HeuristicSyntaxProfile {
    HeuristicSyntaxProfile {
        ...
        object_pronouns: &[
            "माम्", "त्वाम्", "एनम्", "एनाम्", "तत्", "अस्मान्", "युष्मान्", "mām", "tvām",
            "enam", "enām", "tat", "asmān", "yuṣmān",
        ],
        auxiliaries: &["अस्मि", "असि", "अस्ति", "स्मः", "स्थ", "सन्ति", "आसीत्"],
        copulas: &[
            "अस्मि", "असि", "अस्ति", "स्मः", "स्थ", "सन्ति", "आसीत्", "asmi", "asi", "asti",
            "smaḥ", "stha", "santi", "āsīt",
        ],
        prepositions: &["प्रति", "अनु", "अधि", "उप", "परि", "वि"],
        postpositions: &["मध्ये", "पूर्वम्", "परम्", "अर्थम्", "madhye", "pūrvam", "param", "artham"],
