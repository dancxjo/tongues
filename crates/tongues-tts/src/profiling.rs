...
impl SynthesisStage {
    pub const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::ReferenceConditioning => "reference_conditioning",
            Self::TextEncoder => "text_encoder",
            Self::AutoregressiveFirstCode => "autoregressive_first_code",
            Self::AutoregressiveGeneration => "autoregressive_generation",
            ...
            Self::FeatureConversion => "feature_conversion",
            Self::VitsFlow => "vits_flow",
            Self::WaveformDecoder => "waveform_decoder",
            Self::StreamAssembly => "stream_assembly",
